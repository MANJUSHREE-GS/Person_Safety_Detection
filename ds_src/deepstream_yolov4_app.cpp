  ...
  Odin::addDisplayMeta(gpointer batch_meta_data, gpointer frame_meta_data, int status) {
    ...
    txt_params->text_bg_clr.alpha = 1.0;
      ...
      // NvOSD_LineParams *line_params  = display_meta->line_params;
       line_params[0].x1 = 436;//for demonstration, user need to se these values
       line_params[0].y1 = 142;
       line_params[0].x2 = 900;
       line_params[0].y2 = 142;
       line_params[0].line_width = 4;
       line_params[0].line_color = (NvOSD_ColorParams){1.0, 0.0, 0.0, 1.0};
       display_meta->num_lines++;

        line_params[1].x1 = 900;//for demonstration, user need to se these values
       line_params[1].y1 = 142;
       line_params[1].x2 = 900;
       line_params[1].y2 = 1042;
       line_params[1].line_width = 4;
       line_params[1].line_color = (NvOSD_ColorParams){1.0, 0.0, 0.0, 1.0};
       display_meta->num_lines++;

        line_params[2].x1 = 900;//for demonstration, user need to se these values
       line_params[2].y1 = 1042;
       line_params[2].x2 = 436;
       line_params[2].y2 = 1042;
       line_params[2].line_width = 4;
       line_params[2].line_color = (NvOSD_ColorParams){1.0, 0.0, 0.0, 1.0};
       display_meta->num_lines++;
       
        line_params[3].x1 = 436;//for demonstration, user need to se these values
       line_params[3].y1 = 1042;
       line_params[3].x2 = 436;
       line_params[3].y2 = 142;
       line_params[3].line_width = 4;
       line_params[3].line_color = (NvOSD_ColorParams){1.0, 0.0, 0.0, 1.0};
       display_meta->num_lines++;
  ...
  Odin::tiler_src_pad_buffer_probe(GstPad *pad, GstPadProbeInfo *info,
    ...
    for (l_frame = batch_meta->frame_meta_list; l_frame != NULL;
     ...
     int status = -1;
      ...
      data.emplace_back(cv::Point2f(436, 142));
      data.emplace_back(cv::Point2f(900, 142));
      data.emplace_back(cv::Point2f(900, 1042));
      data.emplace_back(cv::Point2f(436, 1042));
